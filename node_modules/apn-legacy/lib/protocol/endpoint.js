...
module.exports = function (dependencies) {
  ...
  Endpoint.prototype._setupHTTP2HealthCheck = function healthcheck() {
    ...
    return setInterval(function () {
      if (_this2._lastSuccessPingedTime != null && Date.now() - _this2._lastSuccessPingedTime > _this2._pingedThreshold) {
        _this2._error("Not receiving Ping response after " + _this2._pingedThreshold + " ms");
      } else {
        _this2._connection.ping(function () {
          _this2._lastSuccessPingedTime = Date.now();
        });
      }
  ...
  Endpoint.prototype.createStream = function createStream() {
    ...
    stream.on("end", function () {
      stream = null;
      _this4._acquiredStreamSlots -= 1;
      _this4.emit("wakeup");

      if (_this4._closePending) {
        _this4.close();
      }
    });
